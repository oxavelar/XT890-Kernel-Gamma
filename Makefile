...
BOOT_CMDLINE="init=/init pci=noearly console=logk0 vmalloc=200M earlyprintk=nologger hsu_dma=7 kmemleak=off transparent_hugepage=always androidboot.bootmedia=sdcard androidboot.hardware=sc1 emmc_ipanic.ipanic_part_number=6 loglevel=4"
