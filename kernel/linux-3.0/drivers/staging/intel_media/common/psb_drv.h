...
struct drm_psb_private {
	...
	*/
	...
	bool dpi_panel_on;
	/* reboot notifier for dbi panel to shutdown */
	struct notifier_block dbi_panel_reboot_notifier;
...
#define DRM_PSB_HDMI_FLIP_ARRAY_SIZE 4
	...
	/* flag to indicate if set the screen to init screen
	 * before the screen is powered off
	 */
	int init_screen_off;
