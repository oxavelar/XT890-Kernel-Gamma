...
//Begin MOT w18918 IKHSS6-1352
#define WL1271_WAKEUP_PERIOD_MAX 300
//End MOT IKHSS6-1352
...
sta_not_found:
	...
	if (do_join) {
        //Begin MOT w18918 IKHSS6-1352
                ...
                /* set the wakeup period so that is as close to WAKEUP_PERIOD_MAX as possible */
                wl1271_info("bss_conf->beacon_int %d bss_conf->dtim_period %d",
                        bss_conf->beacon_int, bss_conf->dtim_period);

                // Begin MOT w18918 IKHSS6-6558
                /* avoid situation where tbd is 0 for some reason; wakeup on each DTIM */
                tbd = (bss_conf->beacon_int * bss_conf->dtim_period) ? : WL1271_WAKEUP_PERIOD_MAX;
                // End MOT w18918 IKHSS6-6558

                wl->conf.conn.suspend_listen_interval = (WL1271_WAKEUP_PERIOD_MAX / tbd) ? : 1;
                wl1271_info("suspend_listen_interval %d",
                        wl->conf.conn.suspend_listen_interval);
        //End MOT IKHSS6-1352
...
#ifdef CONFIG_HAS_WAKELOCK
	wake_lock_init(&wl->wake_lock, WAKE_LOCK_IDLE, "wl1271_wake");
	wake_lock_init(&wl->rx_wake, WAKE_LOCK_IDLE, "rx_wake");
	wake_lock_init(&wl->recovery_wake, WAKE_LOCK_IDLE, "recovery_wake");
#endif
