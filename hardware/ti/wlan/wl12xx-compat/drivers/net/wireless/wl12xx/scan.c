				  ...
				  struct ieee80211_sched_scan_ies *ies)
{
	...
	int i, ret;
	bool force_passive = !req->n_ssids;
#ifdef  CONFIG_PNO_BGSCAN
	int intervals [] = {45000, 45000, 45000,45000,45000,45000,45000,
	...
	for (i = 0; i < SCAN_MAX_CYCLE_INTERVALS; i++)
		cfg->intervals[i] = cpu_to_le32(intervals[i]);
#endif
	cfg->ssid_len = 0;
