...
dev_vdbg(&akm->i2c->dev, "layout = %d", akm->layout);
		layout = akm->layout;
		break;
	case ECS_IOCTL_GET_ACCEL:
...
static struct device_attribute akm8975_attributes[] = {
	__ATTR(enable_acc, 0660, akm8975_enable_acc_show,
		akm8975_enable_acc_store),
	__ATTR(enable_mag, 0660, akm8975_enable_mag_show,
		akm8975_enable_mag_store),
	__ATTR(enable_ori, 0660, akm8975_enable_ori_show,
		akm8975_enable_ori_store),
	__ATTR(delay_acc,  0660, akm8975_delay_acc_show,
		akm8975_delay_acc_store),
	__ATTR(delay_mag,  0660, akm8975_delay_mag_show,
		akm8975_delay_mag_store),
	__ATTR(delay_ori,  0660, akm8975_delay_ori_show,
		akm8975_delay_ori_store),
#ifdef AKM8975_DEBUG_IF
...
dev_dbg(&client->dev, "%s: layout = %d",  __func__, s_akm->layout);
